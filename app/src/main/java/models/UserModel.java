...
public class UserModel {
    ...
    String profilePic = "R.drawable.user", userName, userMobile, userMail, userId, userPassword = "null", recentMessage, about, token;
    long  recentMsgTime;
    ...
    // For storing in DB
    public UserModel(String userName, String userMail, String userMobile, String profilePic, String about){
