...
import com.example.campusfriends.databinding.ActivitySignupBinding;
...
//                            }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, Home.class); // Replace HomeActivity with the actual class of your home activity
        startActivity(intent);
        finish();
    }
